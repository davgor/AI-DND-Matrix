const GUIDED_PHASE_CHECK =
  "guided_creation_phase IN ('none', 'equipment', 'identity', 'opening_scene', 'complete')"

export const CHARACTERS_V26_DDL = `
  CREATE TABLE characters_v26 (
    id TEXT PRIMARY KEY,
...
export const COPY_CHARACTERS_TO_V26_SQL = `
  INSERT INTO characters_v26 (
