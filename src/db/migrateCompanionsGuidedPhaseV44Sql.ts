const GUIDED_PHASE_CHECK =
  "guided_creation_phase IN ('none', 'race', 'background', 'equipment', 'companions', 'identity', 'opening_scene', 'complete')"

export const CHARACTERS_V44_DDL = `
  CREATE TABLE characters_v44 (
    id TEXT PRIMARY KEY,
...
export const COPY_CHARACTERS_TO_V44_SQL = `
  INSERT INTO characters_v44 (
