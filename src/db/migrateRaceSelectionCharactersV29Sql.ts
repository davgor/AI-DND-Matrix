const GUIDED_PHASE_CHECK =
  "guided_creation_phase IN ('none', 'race', 'equipment', 'identity', 'opening_scene', 'complete')"

export const CHARACTERS_V29_DDL = `
  CREATE TABLE characters_v29 (
    id TEXT PRIMARY KEY,
...
export const COPY_CHARACTERS_TO_V29_SQL = `
  INSERT INTO characters_v29 (
